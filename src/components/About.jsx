...
class About extends React.Component {
    render() {
        ...
        return (<><section id="aboutme" role="main" className="bg-header-purple dark:bg-dark-header">
            ...
            <h2 className="flex initial font-header text-left  text-3xl my-5 text-medium-purple dark:text-skills-pink" aria-label="Hi! I'm Mallory.">Hi! I'm Mallory. <img src="assets/bubble1.gif" className="block h-[2em] w-[5em] ml-[.5em] -mt-[1em] dark:hidden"></img><img src="assets/sparkle1.gif" className="hidden h-[3em] w-[5em] ml-[.25em] -mt-[1em] dark:block"></img></h2>
