...
class Welcome extends React.Component {
    ...
    render() {
        ...
        return (<><section id="welcome" role="region" aria-label="my portfolio" className="bg-light-purple" >
           ...
           <div className="mt-12 pb-22 mb-22 text-medium-purple text-4xl content-evenly">
            <a href="https://wwww.instagram.com/malloryjoycreates"><i class="fa-brands fa-instagram"></i></a>
            <a href="https://wwww.github.com/malloryjoy"><i class="fa-brands fa-github"></i></a>
           ...
           <div className="mt-20 pb-22 mb-22 font-extrabold text-3xl text-dark-purple"><p><a aria-label="Scroll down to about me section" href="#aboutme"><i class="fa-solid fa-chevron-down"></i></a></p></div>
       </div>
        </section>
