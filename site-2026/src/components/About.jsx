...
class About extends React.Component {
    render() {
        ...
        return (<><section id="aboutme" role="main" className="bg-header-purple">
            ...
            <img class="rounded-xl w-md h-lg" id="defaultimage" src="/src/assets/myface.png" alt="Mallory Joy face" />
            <div className="bg-bio-purple absolute top-260 left-150 rounded-xl py-5 px-10 w-1/2 h-3/4 border-t-6 border-r-6 border-l-12 border-b-12 border-medium-purple">
            <h2 class="font-header text-left text-medium-purple text-3xl my-5" aria-label="Hi! I'm Mallory.">Hi! I'm Mallory.</h2>
            <p class="font-body font-bold text-md text-left">I am a front-end developer based out of the east coast of the United States. 
